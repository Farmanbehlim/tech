...
const Showcase = ({ isLightMode }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 pt-32 pb-20 flex flex-col gap-10 max-w-5xl">
        <div className="max-w-4xl">
          <p className={`uppercase tracking-[0.5em] text-sm ${labelColor} mb-6`}>Alif Infotech</p>
